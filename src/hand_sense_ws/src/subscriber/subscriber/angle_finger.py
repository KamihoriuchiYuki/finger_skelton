...
class RsSub(Node):
    ...
    def __init__(self):
        ...
        self.pub = self.create_publisher(Float64MultiArray, 'finger_angle_topic', 10) #pubの定義
    ...
    def listener_callback(self, msg):
        ...
        for i in range(num_joint):
            ...
            msg_data.data.append(angle_joint[i+1]) #上で求めた値を配列に格納する
            count_joint += 1
        self.pub.publish(msg_data) # 配列をpub
