...
class RsSub(Node):
    ...
    def __init__(self):
        ...
        self.model = joblib.load('joint_reliability_model_integ.pkl')
    ...
    def toggle_recording(self):
        ...
        if self.recording:
            ...
            self.video_out = cv2.VideoWriter(f"data_index/index_finger_video_{timestamp}.avi", fourcc, 15.4942, (640, 480))
