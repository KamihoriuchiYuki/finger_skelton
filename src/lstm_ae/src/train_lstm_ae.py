...
params = {
    ...
    "batch_size": 64,
    "missing_rate": 0.0,
    "data_path": "~/Sensor-Glove/src/data_handler/data/0813_1559_ind_sample.csv"
}
...
history = model.fit(XY_train_zero, XY_train_zero, epochs=epochs, batch_size=batch_size, shuffle=True, validation_data=(XY_train_zero, XY_train_zero))
