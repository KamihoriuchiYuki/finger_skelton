...
base_path = os.path.expanduser("~/Sensor-Glove/src/lstm_ae/results/important_data/models")
save_dir = os.path.expanduser("~/Sensor-Glove/src/lstm_ae/results/important_data/results")
# Define the evaluation data paths and corresponding filenames
evaluation_data_paths = {
    "same_pg": "~/Sensor-Glove/src/data_handler/data/divided/sg_350_440_5.csv",  # 1728
    "same_p_diff_time": "~/Sensor-Glove/src/data_handler/data/divided/sg_500_620_4.csv",  # 1751
    "same_g_diff_p": "~/Sensor-Glove/src/data_handler/data/divided/sg_350_450_10.csv",  # 1744
}

# Define the model names
model_names = ["RS", "RS_missing", "RS_SG_missing"]
...
for eval_name, data_path in evaluation_data_paths.items():
    ...
    save_path = os.path.join(save_dir, f'{eval_name}_data_summary.csv')
