...
history = LSTM_AE.fit([X_train, X_train_rev], X_train, epochs=epochs, batch_size=300, shuffle=True, validation_data=([X_train, X_train_rev], X_train))

# LSTM_AE.fit(X_train, X_train, epochs=epochs, batch_size=300, shuffle=True, validation_data=(X_train, X_train))
...
def plot_save(start_index, X_hat, X_train, X_class):
    ...
    savename = "./" + "single_" + str(epochs) + "ep/" + "AE_reconst_" + str(epochs) + "ep_start_" + str(start_index) + "_cls" + str(X_class) + ".png"
